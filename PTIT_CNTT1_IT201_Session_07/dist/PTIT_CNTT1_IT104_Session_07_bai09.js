...
class User {
    ...
    comment(postId, idCM, commentContent) {
...
class Comment {
    ...
    contentComment;
    replies = [];
    constructor(id, userId, contentComment) {
        this.id = id;
        this.userId = userId;
...
User2.viewFeed();
//# sourceMappingURL=PTIT_CNTT1_IT104_Session_07_bai09.js.map